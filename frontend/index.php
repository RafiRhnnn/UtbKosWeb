...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse">
                ...
                <a class="btn btn-outline-dark btn-lg rounded-pill ms-lg-3 px-4 py-2"
    ...
    <section id="promo" class="vh-100">
        ...
        <p id="promoDescription" class="text-center mt-4">Dapatkan diskon spesial hingga 30% untuk kost pilihan di
            berbagai lokasi strategis.</p>
    </section>
    <!-- Promo Section End -->
    ...
    <section id="feature" class="vh-100">
        <div class="container">
