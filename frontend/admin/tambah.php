                ...
                <div class="card-body">
                    ...
                    <form id="addNewsForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="alamatkos" name="alamatkos" class="form-control" maxlength="50"
                                required>
                        </div>
                        <div class="mb-3">
                            <label for="hargasewa" class="form-label">Harga Sewa /Bulan:</label>
                            <input type="text" id="hargasewa" name="hargasewa" class="form-control" maxlength="50"
                                required>
                        </div>
                        <div class="mb-3">
                            ...
                            <select id="tipe" name="tipe" class="form-control" required>
                                ...
                                <option value="perempuan">Putra</option>
                                <option value="laki-laki">Putri</option>
                                <option value="campur">Campur</option>
                            </select>
                        </div>
                        <div class="mb-3">
                            <label for="notelp" class="form-label">Nomor Telepon: Gunakan kode negara</label>
                            <input type="text" id="notelp" name="notelp" class="form-control" maxlength="15" required>
                        </div>
                        <div class="mb-3">
